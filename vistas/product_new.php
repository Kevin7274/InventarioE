<div class="container is-fluid mb-6">
	<h1 class="title">Mobiliario</h1>
	<h2 class="subtitle">Nuevo mobiliario</h2>
</div>
	...
	<form action="./php/producto_guardar.php" method="POST" class="FormularioAjax" autocomplete="off" enctype="multipart/form-data" >
		...
		<div class="columns">
		  	<div class="column">
		    	<div class="control">
					<label>Modelo</label>
				  	<input class="input" type="text" name="producto_modelo" pattern="[a-zA-Z0-9- ]{1,70}" maxlength="70" required >
				</div>
		  	</div>
		  	<div class="column">
		    	<div class="control">
		...
		<div class="columns">
			<div class="column">
				<label>Foto o imagen del mobiliario</label><br>
